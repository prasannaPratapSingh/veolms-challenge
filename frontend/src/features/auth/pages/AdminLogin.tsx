    ...
    <div style={{
      ...
      <motion.div {...fadeUp(0)} style={{ position: "relative", width: "100%", maxWidth: "420px" }}>
        <div style={{
          ...
          <motion.div {...fadeUp(0.05)} style={{ marginBottom: "2.25rem" }}>
            ...
            <div style={{ marginBottom: "1rem" }}>
              <span style={{
                ...
                color: "#c8a96e", fontSize: "0.62rem", fontWeight: 700,
                letterSpacing: "0.12em", textTransform: "uppercase",
                padding: "0.25rem 0.8rem", borderRadius: "2px",
              }}>
                <span style={{ display: "block", width: "5px", height: "5px", borderRadius: "50%", background: "#c8a96e" }} />
                Admin Portal
              </span>
            </div>
          ...
          <motion.p {...fadeUp(0.25)} style={{ textAlign: "center", color: "rgba(237,232,223,0.25)", fontSize: "0.78rem", marginTop: "1.5rem" }}>
            <Link to="/login" style={{
              color: "rgba(200,169,110,0.45)", textDecoration: "none",
              borderBottom: "1px solid rgba(200,169,110,0.15)", paddingBottom: "1px",
              transition: "color 0.2s",
            }}
              onMouseEnter={e => ((e.currentTarget as HTMLElement).style.color = "#c8a96e")}
              onMouseLeave={e => ((e.currentTarget as HTMLElement).style.color = "rgba(200,169,110,0.45)")}>
